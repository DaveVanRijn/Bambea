                    ...
                    <div class="table-responsive" style="height: 500px; overflow: auto;">
                        <table class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th><spring:message code="rules.add.step3.list.action"/></th>
                                    <th> </th>
                                </tr>
                            </thead>
                            <tbody>
                                <c:forEach var="action" items="${actionList}">
                                    <tr>
                                        <td>${action.id}</td>
                                        <td>${action.name}</td>
                                        <td><a href="${gekozenBeacon.id}/${action.id}"><button type="button" class="btn btn-default btn-xs"><spring:message code="general.choose"/></button></a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
